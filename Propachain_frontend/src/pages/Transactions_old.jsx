            ...
            <div className="flex items-center gap-3">
              {needsAction && !transaction.hasDispute && (
                <Button
                  ...
                  className="bg-white border-2 border-gray-200 hover:from-blue-700 hover:to-purple-700"
                >
                  {isConfirming ? (
                    <>
  ...
  if (!walletAddress) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh]">
        <div className="w-20 h-20 bg-white border-2 border-gray-200 rounded-full flex items-center justify-center mb-6">
